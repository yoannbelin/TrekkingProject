...
#include "../../minibrowser/cpp/filemanager.h"
...
QT_MOC_LITERAL(1, 12, 14), // "pathwayChanged"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 7), // "pathway"
QT_MOC_LITERAL(4, 36, 10) // "setPathway"

    },
    "FileManager\0pathwayChanged\0\0pathway\0"
    "setPathway"
};
...
void FileManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->pathwayChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->setPathway((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FileManager::pathwayChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->getPathway(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setPathway(*reinterpret_cast< QString*>(_v)); break;
        default: break;
        }
...
// SIGNAL 0
void FileManager::pathwayChanged(QString _t1)
{
