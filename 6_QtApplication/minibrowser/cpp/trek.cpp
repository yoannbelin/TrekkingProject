...
Trek::Trek(QObject *parent)
    : m_label("trek_name"), m_length("1"), m_time("00:00:00"), m_level("1"), m_done(1), QObject(parent)
{
...
Trek::Trek(const QString &label,  const double &latitude, const double &longitude, QObject *parent)
    : m_label(label), m_length("1"), m_time("00:00:00"), m_level("1"), m_done(1), QObject(parent)
{
