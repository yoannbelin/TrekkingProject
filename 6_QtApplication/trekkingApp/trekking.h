...
public:
    explicit Trekking(QObject *parent = nullptr);

    Trekking(const QString &originalUrl ,const QString &targetUrl ,const QString &originalString ,const QString &replacementString ,QObject *parent = 0);
