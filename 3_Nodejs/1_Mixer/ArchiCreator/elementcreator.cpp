...
ElementCreator::ElementCreator(QObject *parent) : QObject(parent)
{

}

ElementCreator::ElementCreator( const QString &originalUrl, const QString &targetUrl, const QString &originalString,
...
void ElementCreator::copyOriginalFolder()
{
...
void ElementCreator::createFolderCopy(const QString &originalUrl, const QString &targetUrl)
{
...
void ElementCreator::createFileCopy(const QString &originalFilePath, const QString &newFilePath)
{
...
QStringList ElementCreator::replaceOriginalStrings(const QStringList &textSample)
{
...
QString ElementCreator::replaceOriginalString(const QString &stringSample)
{
...
QString ElementCreator::convertToStringStartingWithUpperCase(const QString &stringStartingWithLowerCase)
{
